...
function ProductList({ handleGetStartedClick }) {
    ...
    const handleRemovedFromCartCompletely = (name) => {
        setAddedToCart((prevState) => ({
            ...prevState,
            [name]: false
        }));
    ...
    return (
        <div>
            ...
            {!showCart ?
                ...
                :
                (
                    <Cart onContinueShopping={handleContinueShopping} handleRemovedFromCartCompletely={handleRemovedFromCartCompletely} />
                )}
